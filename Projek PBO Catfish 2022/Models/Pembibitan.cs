...
{
    public class Pembibitan : Aktivitas
    {

        string id_karyawan;
        string id_kolam;
        string id_Pembibitan;

        public Pembibitan(string id = null, string tanggal = null, string id_karyawan = null, string id_kolam = null) : base(id, tanggal)
        {
            this.id_karyawan = id_karyawan;
            this.id_kolam = id_kolam;
            this.id_Pembibitan = "1";
        }
        ...
        public override void createAktivitas()
        {
            ...
            query = string.Format(query, getTanggal(), this.id_karyawan, this.id_kolam, this.id_Pembibitan);
        ...
        public override DataTable readAktivitas()
        {
            ...
            string query = @"SELECT * FROM 
                             ...
                             JOIN karyawan ka ON ka.id_karyawan = a.id_karyawan
                             WHERE id_jenis_aktivitas = 1
                             ; ";
        ...
        public override void updateAktivitas()
        {
            ...
            ExecuteNonQuery(query,
                ...
                new NpgsqlParameter("@id_p", this.id_Pembibitan)
                );
            //System.Diagnostics.Debug.WriteLine(getId()+"|"+getTanggal()+"|"+id_karyawan+"|"+id_kolam+"|"+id_Pembibitan);
        }
