...
{
    public partial class _Pembibitan : System.Web.UI.Page
    {
        ...
        protected void perintahGridView(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                //intitialize objek baru dari kelas Pembibitan
                //parameter nama dikosongin karena untuk hapus gaperlu
                Pembibitan a = new Pembibitan(id_a, "");
                a.deleteAktivitas();
                isiData();
            }
        ...
        protected void tombolSimpanClick(object sender, EventArgs e)
        {
            ...
            Pembibitan a = new Pembibitan("", tgl,id_karyawan,id_kolam);
            a.createAktivitas();
            isiData();
            panel.Visible = true;
        ...
        protected void tombolUpdateClick(object sender, EventArgs e)
        {
            ...
            string id_karyawan = DropDownListKaryawan.Text;
            string id_kolam = DropDownListKolam.Text;
            Pembibitan a = new Pembibitan(id, tgl, id_karyawan, id_kolam);
            a.updateAktivitas();
            isiData();
            panel.Visible = true;
            panelForm.Visible = false;
