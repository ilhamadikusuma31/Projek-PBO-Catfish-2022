<%@ Page Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Panen.aspx.cs" Inherits="Projek_PBO_Catfish_2022._Panen" %>

<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <form id="form" runat="server">
        <div>
            <asp:MultiView runat="server" ID="mv">
                <asp:View runat="server" ID="vPanen">
